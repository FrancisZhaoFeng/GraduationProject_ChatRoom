...
public class CopyOfUser implements java.io.Serializable {
	...
	public CopyOfUser(String username, String password) {
		this.username = username;
		this.password = password;
	}

	/** minimal constructor */
	public CopyOfUser(String username, String password, String telephone, Integer age) {
		this.username = username;
		this.password = password;
	...
	/** minimal constructor */
	public CopyOfUser(String username, String password, String telephone, Integer age, Boolean sex) {
		this.username = username;
		this.password = password;
		this.telephone = telephone;
		this.age = age;
	...
	/** full constructor */
	public CopyOfUser(String username, String password, String telephone, Integer age, boolean sex, boolean online, boolean blacklist, Set friendsForUserid, Set friendsForFriendid, Set chatRoomLogs, Set chatRooms, Set chatPerLogsForReceiverid, Set chatRooms_1, Set chatPerLogsForSenderid) {
		this.username = username;
		this.password = password;
		this.telephone = telephone;
		this.age = age;
