...
<%-- 	<%
	...
	<div class="miaoshu">
		...
		<h1 style="font-size: 18px;">研究目标：</h1>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;本毕业设计是基于Android的局域网聊天室，用Android编写的程序，程序实现一般的文字聊天，语音聊天，图片发送等功能，可作为某局域网的交流工具。<br />
		<h1 style="font-size: 18px;">研究内容：</h1>
		&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;在本毕业设计中，局域网的文字语音通信通过Socket编程实现，Android封装了有关Socket的各种操作，在编程过程中调用封装的函数实现各种功能。基于TCP的Socket编程采用流式套接字。<br />
