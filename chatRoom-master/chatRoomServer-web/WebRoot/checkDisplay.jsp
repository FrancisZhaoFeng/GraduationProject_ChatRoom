...
<html>
	...
	<body>
		...
		<s:if test="#session.SearchStr!=null">
			...
			<s:if test="#session.pageCheckUser==null && #session.pageCheckChatRoom==null && #session.pageCheckChatRoomLog==null && #session.pageCheckChatPerLog==null ">
				<div align="center" style="margin:0px auto;font-size: medium;color: red">
					搜索结果为空
				</div>
			</s:if>
		</s:if>
