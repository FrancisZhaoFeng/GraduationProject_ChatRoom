...
public class DBUtil {
	...
	public static UserInfo signUp(UserInfo u, String password) {
		...
		String sql1 = "insert into userTable(password,userName,birthYear,birthMonth,birthDay,gender,avatarId,isOnline,signupTime,hometown," + "location) values(?,?,?,?,?,?,?,?,?,?,?)";
	...
	public static boolean makeFriends(int id1, int id2) {
		...
		String sql2 = "insert into friendListTable(masterId,friendId,friendName,friendBirthYear,friendBirthMonth, friendBirthDay," + "friendGender,friendAvatarId, friendIsOnline,friendSignupTime,friendHometown,friendLocation) " + "values(?,?,?,?,?,?,?,?,?,?,?,?)";
	...
	public static UserInfo loginToGetUserInfo(int id, String password) {
		// if the password is incorrect, we will then return a userinfo with id
		// set to -1
		Connection con = DBCon.getConnect();
		...
		int avatarId = 0;
		/*
		 * int isOnline = 0; String signupTime = "xx"; String hometown = "xx";
		 * String location = "xx";
		 */try {
			PreparedStatement ps;
			ResultSet rs;
