...
public class ChatActivity extends Activity {
	...
	private TextWatcher mTextWatcher = new TextWatcher() {
		public void afterTextChanged(Editable s) {
			...
			if (LineAcc > ChatActivity.this.mCurLineAcc && LineAcc <= 7) {
				...
				LinearLayout.LayoutParams imagebtn_params = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT);
				...
				// test codes
				LinearLayout.LayoutParams topBanner_params = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.WRAP_CONTENT);
		...
		mBtnSend.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				...
				if (!st0.equals("")) {
					...
					LinearLayout.LayoutParams imagebtn_params = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT,
					...
					// test codes
					LinearLayout.LayoutParams topBanner_params = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT,
							LinearLayout.LayoutParams.WRAP_CONTENT);
					topBanner_params.height = topHeight;
	 ...
	 */
	public void updateListviewHistory(List<ChatPerLog> msgs, List<Boolean> isSelf, int type, String name) {
